...
!apt-get install tesseract-ocr-hin tesseract-ocr-mar tesseract-ocr-pan tesseract-ocr-guj
!pip install streamlit pytesseract pillow opencv-python-headless
!apt-get update
